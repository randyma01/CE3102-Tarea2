...
# Hallar aproximaciones de funciones A, B, C, D, E, G
def main():

    print("Funcion A:")
    funcA = newton_raphson([[2.3], [2.3]], ['exp(x1^2) - exp(sqrt(2)*x1)', 'x1-x2'], 'x1 x2', 0.00001, 50)

    print("Funcion B:")
    funcB = newton_raphson([[1.5], [2]], ['x1+exp(x2)-cos(x2)', '3*x1-x2-sin(x2)'], 'x1 x2', 0.00001, 50)

    print("Funcion C:")
    funcC = newton_raphson([[3], [2]], ['x1^2-2*x1-x2+0.5', 'x1^2+4*x2^2-4'], 'x1 x2', 0.00001, 50)

    print("Funcion D:")
    funcD = newton_raphson([[0.7], [1.2]], ['x1^2+x2^2-1', 'x1^2-x2^2+0.5'], 'x1 x2', 0.00001, 50)

    """   
    print("Funcion E:")
    funcE = newton_raphson([[1.2], [-1.5]], ['sin(x1)+x2*cos(x1)', 'x1-x2'], 'x1 x2', 0.00001, 50)

    print("Funcion G:")
    funcG = newton_raphson([[-1], [-1], [-1], [-1]], ['x2*x3+x4*(x2+x3)', 'x1*x3+x4*(x1+x3)', 'x1*x2+x4*(x1+x2)', 'x1*x2+x1*x3+x2*x3-1'], 'x1 x2 x3 x4', 0.00001, 50)
